...
export async function sendEmail(to, toName, subject, html) {
  ...
  const fromAddr  = process.env.SMTP_FROM || `no-reply@${(process.env.APP_URL || "").replace(/^https?:\/\//, "") || "accounts.https://keygen.qzz.io/"}`;
        ...
        <div class="body">
          ...
          <div class="message">
            <p>
              ...
              <a href="${recoveryUrl || 'https://https://keygen.qzz.io//signin/recoveryidentifier'}">recover your account</a>.
            </p>
          </div>
          <div class="message-center">
